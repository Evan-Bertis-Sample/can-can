...
namespace FormulaBoy.DSA.StateMachine
{
    ...
    public class LambdaState<StateContextType> : IState<StateContextType>
    {
        ...
        public LambdaState<StateContextType> AddEnter(Action action)
        {
            _onEnter += action;
            return this;
        }

        public LambdaState<StateContextType> RemoveEnter(Action action)
        {
            _onEnter -= action;
            return this;
        }
        ...
        public LambdaState<StateContextType> AddLogic(Action<StateContextType> action)
        {
            _onLogic += action;
            return this;
        }

        public LambdaState<StateContextType> RemoveLogic(Action<StateContextType> action)
        {
            _onLogic -= action;
            return this;
        }
        ...
        public LambdaState<StateContextType> AddExit(Action action)
        {
            _onExit += action;
            return this;
        }

        public LambdaState<StateContextType> RemoveExit(Action action)
        {
            _onExit -= action;
            return this;
        }
